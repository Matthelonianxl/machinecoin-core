...
void SetupServerArgs()
{
    ...
    // Masternodes
    gArgs.AddArg("-server", "Accept command line and JSON-RPC commands", false, OptionsCategory::MN);
    ...
    gArgs.AddArg("-masternodeprivkey=<privkey>", "Set the masternode private ", false, OptionsCategory::MN);
