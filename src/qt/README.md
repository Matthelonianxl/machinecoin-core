...
Used to process BIP21 and BIP70 (see https://github.com/machinecoin-project/machinecoin-core/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a machinecoin:... link from a browser).
