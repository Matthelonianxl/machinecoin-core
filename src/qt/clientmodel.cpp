...
void ClientModel::subscribeToCoreSignals()
{
    ...
    m_handler_notify_additional_sync_tip = m_node.handleNotifyAdditionalDataSyncProgressChanged(boost::bind(NotifyAdditionalDataSyncProgressChanged, this, _1, _2, _3, _4, true));
}
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    m_handler_notify_additional_sync_tip->disconnect();
}
